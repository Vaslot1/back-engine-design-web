...
def create_user(variable: schemas.VariableCreate, db: Session = Depends(get_db)):
    db_user = controller.get_variable_by_short_name(db, short_name=variable.short_name)
    if db_user:
