...
@router.post("/varsinindata/", response_model=schemas.VarInitialData)
...
@router.get("/varsinindata/", response_model=List[schemas.VarInitialData])
...
@router.get("/varsinindata/{id}", response_model=schemas.VarInitialData)
