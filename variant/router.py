...
@router.post("/api/variants/", response_model=schemas.Variant)
...
@router.get("/api/variants/", response_model=List[schemas.Variant])
...
@router.get("/api/variants/{id}", response_model=schemas.Variant)
